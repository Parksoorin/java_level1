...
어떤 시점의 시 hour, 분 minute이 매개변수로 주어질 때,
 hour 시 minute 분에 아날로그 시계의 시침과 분침이 몇 도를 이루는지 
 return 하도록 solution 메소드를 작성해주세요.
 ...
 */
class Solution {
	double getHourAngle(int hour){	
		return 360/12*hour;
	}
	double getMinAngle(int min) {
