...
#문제5
핸드폰 화면에 문구를 출력해주는 전광판 어플이 있습니다. 문구는 "happy-birthday"로 설정하였습니다. 
...
문구를 담은 문자열 phrases와 초를 담은 second가 매개변수로 주어질 때,
 화면에 보이는 문자열을 출력하도록 solution 메소드를 작성해 주세요.
단, '_'는 공백을 나타냅니다.
    ...
    public String solution(String phrases, int second) {
      ...
      //  System.out.println(phrases);
        for(int i = 0; i < second; i++) {
        	char a = phrases.charAt(0);
        	phrases = phrases.substring(1);
        	phrases += a;
        //	System.out.println(i + " " + phrases);
        }
        answer = phrases.substring(0, size);
        return answer;
    }
